            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                @if(empty($post->thumbnail))
                    <img id="previewimg" src="{{asset('img/default-avatar.png')}}" alt="No Image" />
                    @else
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a class="dropdown-item" class="btn btn-default btn-flat" href="{{ route('logout') }}"
